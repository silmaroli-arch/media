...
r = client.post("/cadastro", data={
    ...
    "nome_filial": "Consultório Principal",
...
checar("Médico fundador consegue acessar a tela de Filiais", "Consultório Principal" in r.get_data(as_text=True))
r = client.get("/equipe/clinica/configuracoes")
...
# A mesma pergunta de novo (sem mockar a IA) já é respondida instantaneamente
# pela FAQ que acabou de ser aprendida — não precisa chamar a IA de novo.
r = client.post(
    "/paciente/chat",
    data={"pergunta": "Esse gatorade de uva conta como líquido claro?", "exame_id": str(colonoscopia_vitoria_id)},
    follow_redirects=True,
...
texto = r.get_data(as_text=True)
checar("Pergunta repetida é respondida pela FAQ aprendida, sem precisar chamar a IA de novo",
